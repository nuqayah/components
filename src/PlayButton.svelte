<button {title} tabindex=0 bind:this={button} onclick={bubble('click')}>
...
/** @type {{playing?: boolean, title?: string, button?: any}} */
let {playing = false, title = 'Play or pause', button = $bindable(undefined)} = $props()
