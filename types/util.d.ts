 ...
 */
export function debounce<T extends unknown[]>(fn: (...args: T) => unknown, timeout: number): (...args: T) => void;
/**
 * @param {string} string
 ...
 */
export function repeat_click(el: EventTarget, callback: (click_count: number) => void): {
    destroy(): void;
};
export function get_vh_offset(): number;
/** @param {HTMLElement} el */
export function set_top_offset(el: HTMLElement, visible?: boolean): {
 ...
 * @param {Node} cont
 */
export function append_to(el: Node, cont: Node): {
 ...
 */
export function highlight(qry: string | RegExp, str: string, prep_query: (q: string) => string, should_prep_query?: boolean): string;
/**
 ...
 * @param {boolean} [should_prep_query]
 */
export function filterer(query: string, items: string[], filter: (query: string | RegExp, item: string) => boolean, should_prep_query?: boolean): string[];
 ...
 */
export function copy_text(text: string | PromiseLike<string>, avoid_clipboard?: boolean): PromiseLike<void>;
/**
 * @param {string} diff
 * @param {string} [OMITTED_TEXT_MARKER]
 */
export function separate_diff(diff: string, OMITTED_TEXT_MARKER?: string): {
    old: string;
    new: string;
};
 ...
 */
export function focus_trap(node: HTMLElement | SVGElement | string | Array<HTMLElement | SVGElement | string>, options?: import("focus-trap").Options): {
    destroy(): void;
};
/**
 ...
 */
export function in_view(node: Element, params?: InViewParams): {
 ...
 */
export function read_file(file: File, read_as?: "Text" | "BinaryString" | "DataURL" | "ArrayBuffer"): Promise<string | ArrayBuffer>;
/**
 ...
 */
export function open_window<TProps>(component: import("svelte").Component<TProps>, props: TProps, options?: {
    append_css?: boolean;
}): Window;
/**
 * @param {string} id
 * @param {string} file
 */
export function archive_book_images(id: string, file: string): Promise<{
    /**
     * @param {number} i
     * @param {number} [scale]
     */
...
export function get_x_offset_percent(e: MouseEvent & {
...
export function get_items_by_keys(keys: PropertyKey[], o: object): {
    [k: string]: any;
};
export function to_id_map<T extends {
    id: string | number;
}>(data: T[]): {
    [k: string]: T;
};
